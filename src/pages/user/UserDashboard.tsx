...
export default function UserDashboard() {
  ...
  return (
    <UserLayout>
      ...
      >
        <h1 className="text-2xl sm:text-3xl lg:text-4xl text-[#f1f5f9] mb-6 sm:mb-8">Dashboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <GlassCard>
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-2xl text-[#f1f5f9]">Upcoming Exams</h2>
                <Link to="/user/exam-booking">
                  <Button size="sm" className="bg-[#6366f1] text-xs sm:text-sm h-8 sm:h-9">Book More</Button>
                </Link>
              </div>
              <div className="space-y-3 sm:space-y-4">
                {upcomingExams.map((exam) => (
                  <div
                    key={exam.id}
                    className="p-3 sm:p-4 bg-[#0f172a]/50 rounded-lg border border-[#6366f1]/20"
                  >
                    <h3 className="text-sm sm:text-base text-[#f1f5f9] mb-2">{exam.title}</h3>
                    <div className="flex items-center gap-2 sm:gap-4 text-[#94a3b8] text-xs sm:text-sm">
                      <span>{exam.date}</span>
                      <span>•</span>
                      <span>{exam.time}</span>
                    </div>
          ...
          >
            <GlassCard>
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-2xl text-[#f1f5f9]">Recent Applications</h2>
                <Link to="/user/applications">
                  <Button size="sm" className="bg-[#14b8a6] text-xs sm:text-sm h-8 sm:h-9">View All</Button>
                </Link>
              </div>
              <div className="space-y-3 sm:space-y-4">
                {recentApplications.map((app) => (
                  <div
                    ...
                    className="p-3 sm:p-4 bg-[#0f172a]/50 rounded-lg border border-[#6366f1]/20"
                  >
                    <h3 className="text-sm sm:text-base text-[#f1f5f9] mb-2">{app.job}</h3>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[#94a3b8] text-xs sm:text-sm">{app.date}</span>
                    </div>
                  </div>
                ))}
              </div>
